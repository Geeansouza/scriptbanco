...
CREATE TABLE `tblfilmediretor` (
  ...
  CONSTRAINT `Fk_Diretor_FilmeDiretor` FOREIGN KEY (`idDiretor`) REFERENCES `tbldiretor` (`id`),
  CONSTRAINT `Fk_filme_FilmeDiretor` FOREIGN KEY (`idFilme`) REFERENCES `tblfilme` (`id`)
