...
CREATE TABLE `tbldiretornacionalidade` (
  ...
  KEY `Fk_Nacionalidade_DiretorNacionaliade` (`idNacionalidade`),
  CONSTRAINT `Fk_Diretor_DiretorNacionalidade` FOREIGN KEY (`idDiretor`) REFERENCES `tbldiretor` (`id`),
  CONSTRAINT `Fk_Nacionalidade_DiretorNacionaliade` FOREIGN KEY (`idNacionalidade`) REFERENCES `tblnacionalidade` (`id`)
